...
class CourseDetails extends Component {
    ...
    render() {
        ...
        const testimonials = [
            { name: "Swetha", img: `${process.env.PUBLIC_URL}/assets/images/details-page/testimonials/person-1.png`, text: "Industry-Focused and Practical experience...", color1: "#E0002A", color2: "#7A0017" },
            { name: "Riya", img: `${process.env.PUBLIC_URL}/assets/images/details-page/testimonials/person-2.png`, text: "Loved the hands-on projects...", color1: "#D9D9D9", color2: "#737373" },
            { name: "Arjun", img: `${process.env.PUBLIC_URL}/assets/images/details-page/testimonials/person-3.png`, text: "Mentors explained clearly...", color1: "#0D301B", color2: "#299654" },
            { name: "Karan", img: `${process.env.PUBLIC_URL}/assets/images/details-page/testimonials/person-4.png`, text: "Helped me become job ready...", color1: "#D9D9D9", color2: "#737373" },
            { name: "Sahil", img: `${process.env.PUBLIC_URL}/assets/images/details-page/testimonials/person-5.png`, text: "Great community support...", color1: "#FEC530", color2: "#98761D" },
        ];
                    ...
                    <div className="testimonial_details_page">
                        <div className="section_container py-5">
                            ...
                            <div className="testimonial-slider-wrapper">
                                <Swiper
                                    className="testimonial-swiper py-5"
                                    loop={true}
