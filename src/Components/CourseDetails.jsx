...
//         const skills = [
//             { title: 'Problem Solving', icon: `${BASE_IMAGE_URL}details-page/skills/hosting.png` },
//             { title: 'Analytical Thinking', icon: `${BASE_IMAGE_URL}details-page/skills/database.png` },
//             { title: 'Project Execution', icon: `${BASE_IMAGE_URL}details-page/skills/front-end.png` },
//             { title: 'Team Collaboration', icon: `${BASE_IMAGE_URL}details-page/skills/backend.png` },
//             { title: 'Real-World Tools Usage', icon: `${BASE_IMAGE_URL}details-page/skills/project-building.png` }
//         ];
//         const repeatedSkills = [...skills, ...skills, ...skills]; // repeat for loop

//         const testimonials = [
//             { name: "Swetha", img: `${BASE_IMAGE_URL}details-page/testimonials/person-1.png`, text: "Industry-focused training provided strong hands-on experience with practical tasks. Mentors explained concepts clearly, offered guidance, and ensured we could confidently apply skills in real scenarios.", color1: "#E0002A", color2: "#7A0017" },
//             { name: "Riya", img: `${BASE_IMAGE_URL}details-page/testimonials/person-2.png`, text: "Practical exercises and clear guidance helped build confidence in problem-solving. Mentors ensured understanding of real-world tasks and encouraged applying concepts effectively.", color1: "#D9D9D9", color2: "#737373" },
//             { name: "Anjali", img: `${BASE_IMAGE_URL}details-page/testimonials/person-3.png`, text: "Hands-on practical tasks provided real-world experience and strengthened skills. The guidance was clear, structured, and very helpful in understanding how to apply concepts effectively.", color1: "#0D301B", color2: "#299654" },
//             { name: "Karan", img: `${BASE_IMAGE_URL}details-page/testimonials/person-4.png`, text: "The practical approach strengthened skills through real-life examples. Mentors explained concepts clearly, offered support, and ensured we could apply our knowledge confidently.", color1: "#D9D9D9", color2: "#737373" },
//             { name: "Sahil", img: `${BASE_IMAGE_URL}details-page/testimonials/person-5.png`, text: "Structured hands-on tasks and real-world exercises improved problem-solving and application skills. Mentors provided guidance at every step and ensured clarity in all concepts.", color1: "#FEC530", color2: "#98761D" },
//         ];
