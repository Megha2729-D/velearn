                                ...
                                <div className="row justify-content-center">
                                    <div className="col-lg-10">
                                        <div className="col-12 position-relative">
                                            <img src={`${BASE_IMAGE_URL}live-course/digital-marketing/dm-logo.png`} className="w-100" alt="" />
                                ...
                                >
                                    ...
                                    {sliderTestimonalData.map((item, index) => (
                                        <SwiperSlide key={index}>
                                            ...
                                            >
                                                <img src={`${BASE_IMAGE_URL}live-course/digital-marketing/testimonial/${item.image}`} alt={item.name} />
                                                <div>
...
export default withRouter(DigitalMarketing);
