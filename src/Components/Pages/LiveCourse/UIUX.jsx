                            ...
                            <div className="modal-content border-0 shadow-lg" style={{ borderRadius: '15px' }}>
                                <div className="modal-body text-center p-5">
                                    ...
                                    <p className="text-muted mb-4">
                                        Are you sure you want to enroll in the <strong>UI/UX Design</strong> live program?
                                    </p>
                        ...
                        <div className="row w-100  m-auto">
                            ...
                            <div className="col-lg-4 d-flex justify-content-lg-end justify-content-center">
                                <div className="uiux-right mt-5 mt-lg-0">
                                    <form className="uiux-form" onSubmit={this.handleEnroll}>
                                        <div className="my-1">
                            ...
                            <div className="col-12 d-flex justify-content-center banner_center_piece">
                                <div className="col-lg-7 mt-4 mt-lg-0">
                                    <img src={`${BASE_IMAGE_URL}live-course/ui-ux/ux.png`} className="w-100" alt="" />
                                </div>
                            </div>
                    ...
                    <div className="section_container">
                        <div className="row justify-content-center">
                            <div className="col-lg-8">
                                ...
                                <img src={`${BASE_IMAGE_URL}live-course/ui-ux/tools.png`} className="w-100" alt="" />
                            </div>
                        </div>
                    </div>
                </section>
                                    ...
                                    <div className="cards-box">
                                        <div className="card">
                                            <div className="d-flex gap-4 align-items-center">
                                                <img src={`${BASE_IMAGE_URL}live-course/ui-ux/testimonial/person-1.png`} alt="" />
                                        ...
                                        <div className="card">
                                            <div className="d-flex gap-4 align-items-center">
                                                <img src={`${BASE_IMAGE_URL}live-course/ui-ux/testimonial/person-2.png`} alt="" />
                                                <p>I was confused about UI and UX before joining this course. The way concepts were explained with real examples made everything clear. I now understand user flow, wireframes, and design decisions — not just tools.</p>
                                            </div>
                                        </div>
                                        <div className="card">
                                            <div className="d-flex gap-4 align-items-center">
                                                <img src={`${BASE_IMAGE_URL}live-course/ui-ux/testimonial/person-3.png`} alt="" />
                                                <p>I was confused about UI and UX before joining this course. The way concepts were explained with real examples made everything clear. I now understand user flow, wireframes, and design decisions — not just tools.</p>
                                            </div>
                                        </div>
                                        <div className="card">
                                            <div className="d-flex gap-4 align-items-center">
                                                <img src={`${BASE_IMAGE_URL}live-course/ui-ux/testimonial/person-4.png`} alt="" />
                                                <p>I was confused about UI and UX before joining this course. The way concepts were explained with real examples made everything clear. I now understand user flow, wireframes, and design decisions — not just tools.</p>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-lg-6 d-flex align-items-center justify-content-center p-lg-5">
                                                    <div className=" d-flex align-items-center justify-content-center">
                                                        <div className="col-lg-10">
                                                            <img src={`${BASE_IMAGE_URL}details-page/certificate.jpg`} className="w-100 rounded-5" alt="" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
export default withRouter(UIUX);
