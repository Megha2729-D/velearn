...
class LoginPage extends Component {
    ...
    handleSubmit = async (e) => {
        ...
        try {
            ...
            // Trigger storage-update for other components
                            ...
                            <form onSubmit={this.handleSubmit} className="login-form">
                                <div className="login-form-inner">
                                    ...
                                    <div className="forgot-pwd-wrapper text-end">
                                        <Link to="/forgot-password" style={{ color: "var(--c2)", fontSize: "14px", fontWeight: "500" }}>Forgot Password?</Link>
                                    </div>

                                    <button type="submit" className="rounded-button login-cta mb-4">
